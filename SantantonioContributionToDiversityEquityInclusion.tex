...
\begin{minipage}{0.95 \linewidth}
	\emph{\textbf{Note to CSU:} I have spent much time considering these issues. You can find a detailed version of my thoughts and the initiatives I intend to pursue here:} \href{https://github.com/nsantantonio/ColoradoStateWheat/blob/master/SantantonioDEIContributionLong.pdf}{\small{github.com/nsantantonio/ColoradoStateWheat/blob/master/SantantonioDEIContributionLong.pdf}} 
\end{minipage}
}
